...
class KFWeap_SMG_UMP45_SWAT extends KFWeap_SMGBase;
...
defaultproperties
{
    ...
    InventorySize=5
    GroupPriority=90 //60
    WeaponSelectTexture=Texture2D'SWATIcon.UMP'
    ...
    // Zooming/Position
    IronSightPosition=(X=5.0f,Y=-0.3.0f,Z=1.7)  //x0.9
    PlayerViewOffset=(X=3.f,Y=10.0f,Z=-2.0f)
    // IronSightPosition=(X=10.f,Y=0,Z=0)
    //PlayerViewOffset=(X=17.f,Y=8,Z=-4.0)

	// Content
	PackageKey="WEP_1P_UMP45_SWAT"
	FirstPersonMeshName="WEP_1P_UMP45_SWAT.ump"
...
// Recoil
   ...
   // RecoilMinPitchLimit=65035
	...
	InstantHitDamage(ALTFIRE_FIREMODE)=47.0 //25
